...
contract ConveyorImp4 {
  ...
  string internal constant CB_U_CONV_P3 = string.concat(ConveyorAdditional5.getPart(), ConveyorAdditional6.getPart());
  ...
  string internal constant CB_U_CONV_P4 = string.concat(ConveyorAdditional7.getPart(), ConveyorAdditional8.getPart());
