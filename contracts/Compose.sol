...
contract Compose {
    ...
    // function composeHTMLWithSB(Helper.Trait memory traitData) public view returns (string memory html) {
    //     StringBuilder memory sb = SB.create(128 * 1024);

    //     SB.writeStr(sb, _html.header);
    //     SB.writeStr(sb, _html.imgOpen);
    //     SB.writeStr(sb, "1");
    //     SB.writeStr(sb, _html.imgSrc);
    //     SB.writeStr(sb, _html.baseURI);
    //     SB.writeStr(sb, _html.folder01);
    //     SB.writeStr(sb, traitData.trait01);
    //     SB.writeStr(sb, _html.imgClose);
    //     SB.writeStr(sb, _html.imgOpen);
    //     SB.writeStr(sb, "2");
    //     SB.writeStr(sb, _html.imgSrc);
    //     SB.writeStr(sb, _html.baseURI);
    //     SB.writeStr(sb, _html.folder02);
    //     SB.writeStr(sb, traitData.trait02);
    //     SB.writeStr(sb, _html.imgClose);
    //     SB.writeStr(sb, _html.imgOpen);
    //     SB.writeStr(sb, "3");
    //     SB.writeStr(sb, _html.imgSrc);
    //     SB.writeStr(sb, _html.baseURI);
    //     SB.writeStr(sb, _html.folder03);
    //     SB.writeStr(sb, traitData.trait03);
    //     SB.writeStr(sb, _html.imgClose);
    //     SB.writeStr(sb, _html.imgOpen);
    //     SB.writeStr(sb, "4");
    //     SB.writeStr(sb, _html.imgSrc);
    //     SB.writeStr(sb, _html.baseURI);
    //     SB.writeStr(sb, _html.folder04);
    //     SB.writeStr(sb, traitData.trait04);
    //     SB.writeStr(sb, _html.imgClose);
    //     SB.writeStr(sb, _html.imgOpen);
    //     SB.writeStr(sb, "5");
    //     SB.writeStr(sb, _html.imgSrc);
    //     SB.writeStr(sb, _html.baseURI);
    //     SB.writeStr(sb, _html.folder05);
    //     SB.writeStr(sb, traitData.trait05);
    //     SB.writeStr(sb, _html.imgClose);
    //     SB.writeStr(sb, _html.imgOpen);
    //     SB.writeStr(sb, "6");
    //     SB.writeStr(sb, _html.imgSrc);
    //     SB.writeStr(sb, _html.baseURI);
    //     SB.writeStr(sb, _html.folder06);
    //     SB.writeStr(sb, traitData.trait06);
    //     SB.writeStr(sb, "_r");
    //     SB.writeStr(sb, _html.imgClose);
    //     SB.writeStr(sb, _html.imgOpen);
    //     SB.writeStr(sb, "7");
    //     SB.writeStr(sb, _html.imgSrc);
    //     SB.writeStr(sb, _html.baseURI);
    //     SB.writeStr(sb, _html.folder07);
    //     SB.writeStr(sb, traitData.trait07);
    //     SB.writeStr(sb, _html.imgClose);
    //     SB.writeStr(sb, _html.footer);

    //     html = Base64.encode(bytes(string(abi.encodePacked(SB.getString(sb)))));
    // }
}