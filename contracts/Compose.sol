...
contract Compose {
    ...
    constructor() {
        ...
        _html.baseURI = "https://anma.mypinata.cloud/ipfs/QmRYNkQPy7R1uZhyT3d2Np65U1w8uS8cpnTA9xu9WpneXG/";
        _html
    ...
    function composeHTML(string[9] memory floor) public view returns (string memory) {
        string memory output = string.concat(composeFloor(floor));
